...
public class mrzjniInterfaceJNI {
  ...
  public static final native long MrzEngineInternalSettings_createFromFilesystem(String str) throws MrzException;

  public static final native long MrzEngineInternalSettings_createFromZipBuffer(String str) throws MrzException;
  ...
  public static final native boolean MrzEngineSessionSettings_get_anywhere_enabled(long j, MrzEngineSessionSettings mrzEngineSessionSettings);

  public static final native boolean MrzEngineSessionSettings_get_chedl_support_enabled(long j, MrzEngineSessionSettings mrzEngineSessionSettings);
  ...
  public static final native boolean MrzEngineSessionSettings_get_server_mode_enabled(long j, MrzEngineSessionSettings mrzEngineSessionSettings);
  ...
  public static final native void MrzEngineSessionSettings_set_anywhere_enabled(long j, MrzEngineSessionSettings mrzEngineSessionSettings, boolean z);

  public static final native void MrzEngineSessionSettings_set_chedl_support_enabled(long j, MrzEngineSessionSettings mrzEngineSessionSettings, boolean z);
  ...
  public static final native void MrzEngineSessionSettings_set_server_mode_enabled(long j, MrzEngineSessionSettings mrzEngineSessionSettings, boolean z);
  ...
  public static final native void MrzEngine_FeedImageFile__SWIG_0(long j, MrzEngine mrzEngine, String str, int i) throws MrzException;

  public static final native void MrzEngine_FeedImageFile__SWIG_1(long j, MrzEngine mrzEngine, String str) throws MrzException;

  public static final native void MrzEngine_FeedUncompressedImageData__SWIG_0(long j, MrzEngine mrzEngine, byte[] bArr, int i, int i2, int i3, int i4, long j2, MrzRect mrzRect, int i5) throws MrzException;

  public static final native void MrzEngine_FeedUncompressedImageData__SWIG_1(long j, MrzEngine mrzEngine, byte[] bArr, int i, int i2, int i3, int i4, long j2, MrzRect mrzRect) throws MrzException;

  public static final native void MrzEngine_FeedUncompressedYUVImageData__SWIG_0(long j, MrzEngine mrzEngine, byte[] bArr, int i, int i2, int i3, long j2, MrzRect mrzRect, int i4) throws MrzException;

  public static final native void MrzEngine_FeedUncompressedYUVImageData__SWIG_1(long j, MrzEngine mrzEngine, byte[] bArr, int i, int i2, int i3, long j2, MrzRect mrzRect) throws MrzException;

  public static final native void MrzEngine_InitializeSession__SWIG_0(long j, MrzEngine mrzEngine, long j2, StreamReporterInterface streamReporterInterface, long j3, MrzEngineSessionHelpers mrzEngineSessionHelpers, long j4, MrzEngineSessionSettings mrzEngineSessionSettings) throws MrzException;

  public static final native void MrzEngine_InitializeSession__SWIG_1(long j, MrzEngine mrzEngine, long j2, StreamReporterInterface streamReporterInterface, long j3, MrzEngineSessionHelpers mrzEngineSessionHelpers) throws MrzException;

  public static final native void MrzEngine_InitializeSession__SWIG_2(long j, MrzEngine mrzEngine, long j2, StreamReporterInterface streamReporterInterface) throws MrzException;

  public static final native void MrzEngine_TerminateSession(long j, MrzEngine mrzEngine) throws MrzException;

  public static final native String MrzException_what(long j, MrzException mrzException);

  public static final native int MrzField_calculateChecksum(long j, MrzField mrzField) throws MrzException;
  ...
  public static final native float MrzImageCheck_computeFlashConfidence(byte[] bArr, int i, int i2, int i3, int i4) throws MrzException;

  public static final native int MrzImageCheck_computeFocusConfidence(byte[] bArr, int i, int i2, int i3, int i4) throws MrzException;

  public static final native boolean MrzImageCheck_isFlashNeeded(byte[] bArr, int i, int i2, int i3, int i4, int i5) throws MrzException;

  public static final native boolean MrzImageCheck_isRefocusNeeded(byte[] bArr, int i, int i2, int i3, int i4, int i5) throws MrzException;
  ...
  public static final native char MrzOcrChar_GetChar(long j, MrzOcrChar mrzOcrChar) throws MrzException;
  ...
  public static final native long new_MrzEngine(long j, MrzEngineInternalSettings mrzEngineInternalSettings) throws MrzException;

  public static final native long new_MrzEngineSessionHelpers();

  public static final native long new_MrzEngineSessionSettings__SWIG_0();

  public static final native long new_MrzEngineSessionSettings__SWIG_1(long j, MrzEngineSessionSettings mrzEngineSessionSettings);
